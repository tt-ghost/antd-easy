...
var FormItemCheckbox = function (_React$Component) {
  _inherits(FormItemCheckbox, _React$Component);

  function FormItemCheckbox(props) {
    _classCallCheck(this, FormItemCheckbox);

    return _possibleConstructorReturn(this, (FormItemCheckbox.__proto__ || Object.getPrototypeOf(FormItemCheckbox)).call(this, props));
  }

  _createClass(FormItemCheckbox, [{
    key: 'render',
...
exports.default = FormItemCheckbox;