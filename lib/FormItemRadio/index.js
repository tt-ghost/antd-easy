...
var FormItemRadio = function (_React$Component) {
  _inherits(FormItemRadio, _React$Component);

  function FormItemRadio(props) {
    _classCallCheck(this, FormItemRadio);

    return _possibleConstructorReturn(this, (FormItemRadio.__proto__ || Object.getPrototypeOf(FormItemRadio)).call(this, props));
  }

  _createClass(FormItemRadio, [{
    key: 'render',
